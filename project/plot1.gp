...
set out 'Energy.png'
set title "Probabilidad de Percolación en función de la probabilidad de llenado p para L=64"
set key box
...
plot 'stats_Nsize_64.dat' u 1:4:5 title "Probabilidad promedio con desviación estandar producto de 20 repeticiones" lt 7 lc 0 with errorbars, '' u 1:4 title "Modelo" lt 7 lc 8 w l 